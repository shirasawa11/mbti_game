  ...
  scenes: {
    ch5_core: {
      ...
      dialogs: [
        ...
        { speaker: 'maze_keeper', text: '你知道这座迷宫是用来做什么的吗？', emotion: 'curious', delay: 500 },
        { speaker: 'maze_keeper', text: '它不是牢笼——它是一面镜子。', emotion: 'solemn', delay: 400 },
        { speaker: 'maze_keeper', text: '你做的每一个选择，都是你自己。', emotion: 'curious', delay: 500 },
